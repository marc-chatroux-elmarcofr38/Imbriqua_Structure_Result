/// Imported from "/home/elmarcofr38/Documents/Imbriqua_Output_file/2025-07-02_23h01m15/"

/// Class : Activity
mod bpmn_20_activity;
pub use bpmn_20_activity::{ActiveModel as ActivityModel, Entity as Activity};
...
pub use bpmn_20_artifact::{ActiveModel as ArtifactModel, Entity as Artifact};

/// Class : Assignment
mod bpmn_20_assignment;
pub use bpmn_20_assignment::{ActiveModel as AssignmentModel, Entity as Assignment};

/// Class : Association
mod bpmn_20_association;
pub use bpmn_20_association::{ActiveModel as AssociationModel, Entity as Association};

/// Class : Auditing
mod bpmn_20_auditing;
pub use bpmn_20_auditing::{ActiveModel as AuditingModel, Entity as Auditing};

/// Class : BaseElement
mod bpmn_20_base_element;
pub use bpmn_20_base_element::{ActiveModel as BaseElementModel, Entity as BaseElement};

/// Class : BoundaryEvent
mod bpmn_20_boundary_event;
pub use bpmn_20_boundary_event::{ActiveModel as BoundaryEventModel, Entity as BoundaryEvent};
...
pub use bpmn_20_call_activity::{ActiveModel as CallActivityModel, Entity as CallActivity};
...
pub use bpmn_20_catch_event::{ActiveModel as CatchEventModel, Entity as CatchEvent};

/// Class : Category
mod bpmn_20_category;
pub use bpmn_20_category::{ActiveModel as CategoryModel, Entity as Category};

/// Class : CategoryValue
mod bpmn_20_category_value;
pub use bpmn_20_category_value::{ActiveModel as CategoryValueModel, Entity as CategoryValue};

/// Class : Choreography
mod bpmn_20_choreography;
pub use bpmn_20_choreography::{ActiveModel as ChoreographyModel, Entity as Choreography};
...
pub use bpmn_20_collaboration::{ActiveModel as CollaborationModel, Entity as Collaboration};
...
pub use bpmn_20_complex_gateway::{ActiveModel as ComplexGatewayModel, Entity as ComplexGateway};
...
pub use bpmn_20_conversation::{ActiveModel as ConversationModel, Entity as Conversation};
...
pub use bpmn_20_correlation_key::{ActiveModel as CorrelationKeyModel, Entity as CorrelationKey};
...
pub use bpmn_20_data_input::{ActiveModel as DataInputModel, Entity as DataInput};
...
pub use bpmn_20_data_object::{ActiveModel as DataObjectModel, Entity as DataObject};
...
pub use bpmn_20_data_output::{ActiveModel as DataOutputModel, Entity as DataOutput};
...
pub use bpmn_20_data_state::{ActiveModel as DataStateModel, Entity as DataState};

/// Class : DataStore
mod bpmn_20_data_store;
pub use bpmn_20_data_store::{ActiveModel as DataStoreModel, Entity as DataStore};
...
pub use bpmn_20_definitions::{ActiveModel as DefinitionsModel, Entity as Definitions};

/// Class : Documentation
mod bpmn_20_documentation;
pub use bpmn_20_documentation::{ActiveModel as DocumentationModel, Entity as Documentation};

/// Class : EndEvent
mod bpmn_20_end_event;
pub use bpmn_20_end_event::{ActiveModel as EndEventModel, Entity as EndEvent};

/// Class : EndPoint
mod bpmn_20_end_point;
pub use bpmn_20_end_point::{ActiveModel as EndPointModel, Entity as EndPoint};

/// Class : Error
mod bpmn_20_error;
pub use bpmn_20_error::{ActiveModel as ErrorModel, Entity as Error};
...
pub use bpmn_20_escalation::{ActiveModel as EscalationModel, Entity as Escalation};
...
/// Class : Event
mod bpmn_20_event;
pub use bpmn_20_event::{ActiveModel as EventModel, Entity as Event};
...
pub use bpmn_20_expression::{ActiveModel as ExpressionModel, Entity as Expression};

/// Class : Extension
mod bpmn_20_extension;
pub use bpmn_20_extension::{ActiveModel as ExtensionModel, Entity as Extension};
...
pub use bpmn_20_flow_element::{ActiveModel as FlowElementModel, Entity as FlowElement};
...
pub use bpmn_20_flow_node::{ActiveModel as FlowNodeModel, Entity as FlowNode};
...
/// Class : Gateway
mod bpmn_20_gateway;
pub use bpmn_20_gateway::{ActiveModel as GatewayModel, Entity as Gateway};
...
pub use bpmn_20_global_task::{ActiveModel as GlobalTaskModel, Entity as GlobalTask};

/// Class : GlobalUserTask
mod bpmn_20_global_user_task;
pub use bpmn_20_global_user_task::{ActiveModel as GlobalUserTaskModel, Entity as GlobalUserTask};

/// Class : Group
mod bpmn_20_group;
pub use bpmn_20_group::{ActiveModel as GroupModel, Entity as Group};

/// Class : HumanPerformer
mod bpmn_20_human_performer;
pub use bpmn_20_human_performer::{ActiveModel as HumanPerformerModel, Entity as HumanPerformer};
...
/// Class : Import
mod bpmn_20_import;
pub use bpmn_20_import::{ActiveModel as ImportModel, Entity as Import};
...
pub use bpmn_20_input_set::{ActiveModel as InputSetModel, Entity as InputSet};
...
pub use bpmn_20_interface::{ActiveModel as InterfaceModel, Entity as Interface};
...
pub use bpmn_20_item_definition::{ActiveModel as ItemDefinitionModel, Entity as ItemDefinition};

/// Class : Lane
mod bpmn_20_lane;
pub use bpmn_20_lane::{ActiveModel as LaneModel, Entity as Lane};

/// Class : LaneSet
mod bpmn_20_lane_set;
pub use bpmn_20_lane_set::{ActiveModel as LaneSetModel, Entity as LaneSet};
...
pub use bpmn_20_manual_task::{ActiveModel as ManualTaskModel, Entity as ManualTask};

/// Class : Message
mod bpmn_20_message;
pub use bpmn_20_message::{ActiveModel as MessageModel, Entity as Message};
...
pub use bpmn_20_message_flow::{ActiveModel as MessageFlowModel, Entity as MessageFlow};
...
pub use bpmn_20_monitoring::{ActiveModel as MonitoringModel, Entity as Monitoring};
...
pub use bpmn_20_operation::{ActiveModel as OperationModel, Entity as Operation};

/// Class : OutputSet
mod bpmn_20_output_set;
pub use bpmn_20_output_set::{ActiveModel as OutputSetModel, Entity as OutputSet};
...
pub use bpmn_20_participant::{ActiveModel as ParticipantModel, Entity as Participant};
...
pub use bpmn_20_partner_entity::{ActiveModel as PartnerEntityModel, Entity as PartnerEntity};

/// Class : PartnerRole
mod bpmn_20_partner_role;
pub use bpmn_20_partner_role::{ActiveModel as PartnerRoleModel, Entity as PartnerRole};

/// Class : Performer
mod bpmn_20_performer;
pub use bpmn_20_performer::{ActiveModel as PerformerModel, Entity as Performer};

/// Class : PotentialOwner
mod bpmn_20_potential_owner;
pub use bpmn_20_potential_owner::{ActiveModel as PotentialOwnerModel, Entity as PotentialOwner};

/// Class : Process
mod bpmn_20_process;
pub use bpmn_20_process::{ActiveModel as ProcessModel, Entity as Process};

/// Class : Property
mod bpmn_20_property;
pub use bpmn_20_property::{ActiveModel as PropertyModel, Entity as Property};

/// Class : ReceiveTask
mod bpmn_20_receive_task;
pub use bpmn_20_receive_task::{ActiveModel as ReceiveTaskModel, Entity as ReceiveTask};

/// Class : Relationship
mod bpmn_20_relationship;
pub use bpmn_20_relationship::{ActiveModel as RelationshipModel, Entity as Relationship};

/// Class : Rendering
mod bpmn_20_rendering;
pub use bpmn_20_rendering::{ActiveModel as RenderingModel, Entity as Rendering};

/// Class : Resource
mod bpmn_20_resource;
pub use bpmn_20_resource::{ActiveModel as ResourceModel, Entity as Resource};
...
pub use bpmn_20_resource_role::{ActiveModel as ResourceRoleModel, Entity as ResourceRole};

/// Class : RootElement
mod bpmn_20_root_element;
pub use bpmn_20_root_element::{ActiveModel as RootElementModel, Entity as RootElement};

/// Class : ScriptTask
mod bpmn_20_script_task;
pub use bpmn_20_script_task::{ActiveModel as ScriptTaskModel, Entity as ScriptTask};

/// Class : SendTask
mod bpmn_20_send_task;
pub use bpmn_20_send_task::{ActiveModel as SendTaskModel, Entity as SendTask};

/// Class : SequenceFlow
mod bpmn_20_sequence_flow;
pub use bpmn_20_sequence_flow::{ActiveModel as SequenceFlowModel, Entity as SequenceFlow};

/// Class : ServiceTask
mod bpmn_20_service_task;
pub use bpmn_20_service_task::{ActiveModel as ServiceTaskModel, Entity as ServiceTask};

/// Class : Signal
mod bpmn_20_signal;
pub use bpmn_20_signal::{ActiveModel as SignalModel, Entity as Signal};
...
pub use bpmn_20_start_event::{ActiveModel as StartEventModel, Entity as StartEvent};
...
pub use bpmn_20_sub_process::{ActiveModel as SubProcessModel, Entity as SubProcess};

/// Class : Task
mod bpmn_20_task;
pub use bpmn_20_task::{ActiveModel as TaskModel, Entity as Task};
...
pub use bpmn_20_text_annotation::{ActiveModel as TextAnnotationModel, Entity as TextAnnotation};

/// Class : ThrowEvent
mod bpmn_20_throw_event;
pub use bpmn_20_throw_event::{ActiveModel as ThrowEventModel, Entity as ThrowEvent};
...
pub use bpmn_20_transaction::{ActiveModel as TransactionModel, Entity as Transaction};

/// Class : UserTask
mod bpmn_20_user_task;
pub use bpmn_20_user_task::{ActiveModel as UserTaskModel, Entity as UserTask};
...
pub use bpmndi_bpmn_diagram::{ActiveModel as BpmnDiagramModel, Entity as BpmnDiagram};

/// Class : BpmnEdge
mod bpmndi_bpmn_edge;
pub use bpmndi_bpmn_edge::{ActiveModel as BpmnEdgeModel, Entity as BpmnEdge};

/// Class : BpmnLabel
mod bpmndi_bpmn_label;
pub use bpmndi_bpmn_label::{ActiveModel as BpmnLabelModel, Entity as BpmnLabel};

/// Class : BpmnLabelStyle
mod bpmndi_bpmn_label_style;
pub use bpmndi_bpmn_label_style::{ActiveModel as BpmnLabelStyleModel, Entity as BpmnLabelStyle};

/// Class : BpmnPlane
mod bpmndi_bpmn_plane;
pub use bpmndi_bpmn_plane::{ActiveModel as BpmnPlaneModel, Entity as BpmnPlane};

/// Class : BpmnShape
mod bpmndi_bpmn_shape;
pub use bpmndi_bpmn_shape::{ActiveModel as BpmnShapeModel, Entity as BpmnShape};
...
/// DataType : Bounds
mod dc_bounds;
pub use dc_bounds::{ActiveModel as BoundsModel, Entity as Bounds};

/// DataType : Font
mod dc_font;
pub use dc_font::{ActiveModel as FontModel, Entity as Font};

/// DataType : Point
mod dc_point;
pub use dc_point::{ActiveModel as PointModel, Entity as Point};
...
/// Class : Diagram
mod di_diagram;
pub use di_diagram::{ActiveModel as DiagramModel, Entity as Diagram};

/// Class : DiagramElement
mod di_diagram_element;
pub use di_diagram_element::{ActiveModel as DiagramElementModel, Entity as DiagramElement};

/// Class : Edge
mod di_edge;
pub use di_edge::{ActiveModel as EdgeModel, Entity as Edge};

/// Class : Label
mod di_label;
pub use di_label::{ActiveModel as LabelModel, Entity as Label};

/// Class : LabeledEdge
mod di_labeled_edge;
pub use di_labeled_edge::{ActiveModel as LabeledEdgeModel, Entity as LabeledEdge};

/// Class : LabeledShape
mod di_labeled_shape;
pub use di_labeled_shape::{ActiveModel as LabeledShapeModel, Entity as LabeledShape};

/// Class : Node
mod di_node;
pub use di_node::{ActiveModel as NodeModel, Entity as Node};

/// Class : Plane
mod di_plane;
pub use di_plane::{ActiveModel as PlaneModel, Entity as Plane};

/// Class : Shape
mod di_shape;
pub use di_shape::{ActiveModel as ShapeModel, Entity as Shape};
