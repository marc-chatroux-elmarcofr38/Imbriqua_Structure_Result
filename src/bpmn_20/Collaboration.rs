...
pub struct Collaboration<'a> {
    ...
    pub choreography_ref: Option<Vec<&'a Choreography<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub artifacts: Option<Vec<&'a Artifact<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub participant_associations: Option<Vec<&'a ParticipantAssociation<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub message_flow_associations: Option<Vec<&'a MessageFlowAssociation<'a>>>,
    #[builder(setter(into))]
    pub conversation_associations: &'a ConversationAssociation<'a>,
    #[builder(setter(into, strip_option), default)]
    pub participants: Option<Vec<&'a Participant<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub message_flows: Option<Vec<&'a MessageFlow<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub correlation_keys: Option<Vec<&'a CorrelationKey<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub conversations: Option<Vec<&'a ConversationNode<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub conversation_links: Option<Vec<&'a ConversationLink<'a>>>,
}
