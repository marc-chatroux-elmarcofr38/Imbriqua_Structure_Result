...
pub struct Lane<'a> {
    ...
    pub child_lane_set: Option<&'a LaneSet<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub partition_element_ref: Option<&'a BaseElement<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub flow_node_refs: Option<Vec<&'a FlowNode<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub partition_element: Option<&'a BaseElement<'a>>,
}
