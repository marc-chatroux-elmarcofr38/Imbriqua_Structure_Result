...
pub struct Activity<'a> {
    ...
    pub loop_characteristics: Option<&'a LoopCharacteristics<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub resources: Option<Vec<&'a ResourceRole<'a>>>,
    #[builder(setter(into, strip_option), default)]
    ...
    #[builder(setter(into, strip_option), default)]
    pub boundary_event_refs: Option<Vec<&'a BoundaryEvent<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub data_input_associations: Option<Vec<&'a DataInputAssociation<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub data_output_associations: Option<Vec<&'a DataOutputAssociation<'a>>>,
