...
pub struct InputSet<'a> {
    ...
    pub data_input_refs: Option<Vec<&'a DataInput<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub optional_input_refs: Option<Vec<&'a DataInput<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub while_executing_input_refs: Option<Vec<&'a DataInput<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub output_set_refs: Option<Vec<&'a OutputSet<'a>>>,
}
