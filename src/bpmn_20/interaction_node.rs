...
pub struct InteractionNode<'a> {
    #[builder(setter(into, strip_option), default)]
    pub incoming_conversation_links: Option<Vec<&'a ConversationLink<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub outgoing_conversation_links: Option<Vec<&'a ConversationLink<'a>>>,
}
