...
pub struct MultiInstanceLoopCharacteristics<'a> {
    ...
    #[builder(setter(into), default = "MultiInstanceBehavior::all")]
    pub behavior: &'a MultiInstanceBehavior<'a>,
    #[builder(setter(into, strip_option), default)]
    pub loop_cardinality: Option<&'a Expression<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub loop_data_input_ref: Option<&'a ItemAwareElement<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub loop_data_output_ref: Option<&'a ItemAwareElement<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub input_data_item: Option<&'a DataInput<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub output_data_item: Option<&'a DataOutput<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub completion_condition: Option<&'a Expression<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub complex_behavior_definition: Option<Vec<&'a ComplexBehaviorDefinition<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub one_behavior_event_ref: Option<&'a EventDefinition<'a>>,
    #[builder(setter(into, strip_option), default)]
    pub none_behavior_event_ref: Option<&'a EventDefinition<'a>>,
}
