...
pub struct OutputSet<'a> {
    ...
    pub data_output_refs: Option<Vec<&'a DataOutput<'a>>>,
    #[builder(setter(into))]
    pub name: dc::String,
    #[builder(setter(into, strip_option), default)]
    pub input_set_refs: Option<Vec<&'a InputSet<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub optional_output_refs: Option<Vec<&'a DataOutput<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub while_executing_output_refs: Option<Vec<&'a DataOutput<'a>>>,
}
