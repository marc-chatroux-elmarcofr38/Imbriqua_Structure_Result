...
pub struct Process<'a> {
    #[builder(setter(into))]
    pub process_type: &'a ProcessType<'a>,
    #[builder(setter(into))]
    ...
    #[builder(setter(into, strip_option), default)]
    pub supports: Option<Vec<&'a Process<'a>>>,
    #[builder(setter(into, strip_option), default)]
    pub definitional_collaboration_ref: Option<&'a Collaboration<'a>>,
    #[builder(setter(into))]
    ...
    #[builder(setter(into, strip_option), default)]
    pub correlation_subscriptions: Option<Vec<&'a CorrelationSubscription<'a>>>,
}
